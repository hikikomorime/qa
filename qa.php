...
if (is_admin()) { // note the use of is_admin() to double check that this is happening in the admin
		$config = array(
			...
			'api_url' => 'https://api.github.com/repos/hikikomorime/cloner', // the GitHub API url of your GitHub repo
			'raw_url' => 'https://raw.github.com/hikikomorime/cloner/master', // the GitHub raw url of your GitHub repo
			'github_url' => 'https://github.com/hikikomorime/cloner', // the GitHub url of your GitHub repo
			'zip_url' => 'https://github.com/hikikomorime/cloner/zipball/master', // the zip url of the GitHub repo
